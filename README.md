...
How it works:
The Galvanic Extimacy Responder (GER) is our soft sensor based on the GSR – Galvanic Skin Response which
reads electrodermal activity. This sensor has been used in classic lie detector tests to show excitement levels. SENSOREEs GER sensor promotes extimacy – externalized intimacy by showcasing how you feel on the inside to
the outside world. The sensors are located on the hands and reads excitement levels then translates the data into a
palette of affective colors. The Mood Sweater design of the bowl shaped, high collar is positioned with LED lights that reflects onto the self for instant biofeedback as well as act as a tele-display or external blush to communicate to
the other. Located around the neck (larynx), the visual interface offers new language of light and color.
